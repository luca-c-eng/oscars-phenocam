...
echo -e "${YELLOW}  1. Edit SITENAME: sudo nano /etc/phenocam/settings.txt${NC}"
echo -e "${YELLOW}  2. Edit FTP credentials: sudo nano /etc/phenocam/ftp_credentials.txt${NC}"
echo ""
